...
<footer>
<p>This page tracks published work that uses VegasAfterglow. Corrections
— missing papers, misattributed institutes, or removal requests — are welcome
via <a href="https://github.com/YihanWangAstro/VegasAfterglow/issues"
style="color:var(--blue)">GitHub issues</a>.</p>
<p>To cite VegasAfterglow, see
<a href="https://ui.adsabs.harvard.edu/abs/2026JHEAp..5000490W/abstract"
style="color:var(--blue)">Wang, Chen &amp; Zhang (2026, JHEAp, 50, 100490)</a>.</p>
<p>Updated weekly from NASA ADS, OpenAlex and ROR · figures remain © their
authors.</p>
</footer>
</div>
