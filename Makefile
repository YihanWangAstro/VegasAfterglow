...
# === Compiler & flags ===
CXX ?= g++
CXXFLAGS := -std=c++20 -O3 -march=native -flto -Iinclude -Isrc -Iexternal -w -g -DNDEBUG -DXTENSOR_DISABLE_EXCEPTIONS -DXTENSOR_USE_XSIMD -fno-omit-frame-pointer -DEXTREME_SPEED
LDFLAGS := -lz
